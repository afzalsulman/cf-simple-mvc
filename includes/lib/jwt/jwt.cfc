    ...
    public string function encode(
        ...
        if ( !algorithmMap.keyExists( algorithm ) ) {
            throw(
                ...
                type = 'jwtcfml',
                message = 'Invalid JWT Algorithm. Please log out and log in again.',
    ...
    public struct function decode(
        ...
        if ( arrayLen( parts ) != 3 ) {
            throw(
                ...
                type = 'jwtcfml',
                message = 'Invalid JWT. Please log out and log in again.',
        ...
        if ( verify ) {
            if (
                ...
                throw(
                    // type = 'jwtcfml.InvalidAlgorithm',
                    type = 'jwtcfml',
                    message = 'Unsupported or invalid algorithm. Please log out and log in again.',
            ...
            if (
                ...
                throw(
                    ...
                    type = 'jwtcfml',
                    message = 'Signature is Invalid. Please log out and log in again.',
    ...
    private function verifyClaims( payload, claims ) {
        ...
        if (
            ...
            throw(
                ...
                type = 'jwtcfml',
                message = 'Token is not valid. Please log out and log in again.',
        ...
        if ( structKeyExists( claims, 'iss' ) ) {
            if ( !structKeyExists( payload, 'iss' ) || compare( payload.iss, claims.iss ) != 0 ) {
                throw(
                    ...
                    type = 'jwtcfml',
                    message = 'Token has an invalid issuer. Please log out and log in again.',
        ...
        if ( structKeyExists( claims, 'aud' ) ) {
            ...
            if ( !structKeyExists( payload, 'aud' ) || !audArray.find( payload.aud ) ) {
                throw(
                    ...
                    type = 'jwtcfml',
                    message = 'Token has an invalid audience. Please log out and log in again.',
